...
/*==================== REMOVE MENU MOBILE ====================*/
// ghir nclick 3la chi icon mn menu yhbett menu
...
function scrollUp() {
    ...
    // when the scroll is greater than 80 viewport height, add the show-scroll class
...
function sendMail() {
    ...
    const serviceID = "service_qtvifmj";
    const templateID = "template_rku2d1g";
